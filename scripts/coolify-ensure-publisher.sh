...

{
  ...
  [[ -n "$PUBLISHER_CRON_SECRET" ]] && printf 'PUBLISHER_CRON_SECRET=%s\n' "$PUBLISHER_CRON_SECRET"
  [[ -n "$PROFILE_SYNC_TIMEOUT_MS" ]] && printf 'PROFILE_SYNC_TIMEOUT_MS=%s\n' "$PROFILE_SYNC_TIMEOUT_MS"
  [[ -n "$GITHUB_SYNC_API_BASE" ]] && printf 'GITHUB_SYNC_API_BASE=%s\n' "$GITHUB_SYNC_API_BASE"
  [[ -n "$GITHUB_SYNC_USERNAME" ]] && printf 'GITHUB_SYNC_USERNAME=%s\n' "$GITHUB_SYNC_USERNAME"
  [[ -n "$GITHUB_SYNC_TOKEN" ]] && printf 'GITHUB_SYNC_TOKEN=%s\n' "$GITHUB_SYNC_TOKEN"
  [[ -n "$GITHUB_SYNC_WINDOW_DAYS" ]] && printf 'GITHUB_SYNC_WINDOW_DAYS=%s\n' "$GITHUB_SYNC_WINDOW_DAYS"
  [[ -n "$GITHUB_SYNC_MAX_PAGES" ]] && printf 'GITHUB_SYNC_MAX_PAGES=%s\n' "$GITHUB_SYNC_MAX_PAGES"
} >"$tmp_env"
