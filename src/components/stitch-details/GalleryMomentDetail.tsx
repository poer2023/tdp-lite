            ...
            >
              ...
              >
                ...
                >
                  ...
                  />
                  <div className="absolute right-6 top-6 rounded-full border border-white/10 bg-black/20 px-3 py-1.5 font-mono text-[10px] tracking-tight text-white backdrop-blur-md">
