export default function Loading() {
  return (
    <div className="tdp-safe-surface bg-page-surface min-h-dvh">
      ...
      <div className="relative z-10 mx-auto flex max-w-[1400px] flex-col gap-8 px-6 pb-12 pt-[calc(1.5rem+var(--tdp-content-top-inset))] md:px-12 md:pt-[calc(3rem+var(--tdp-content-top-inset))]">
